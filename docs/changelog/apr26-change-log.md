...
**Classes should feel smooth, rewarding, and fun — not restricted by outdated mechanics.**
...
## 🗡️ Rogue Update – Freedom of Execution
...
**Exception:**
- Does **not** include the double-hit mechanic  
...
This shifts the skill expression toward:
- Decision-making  
- Timing  
- Target selection  
...
## 🕊️ Priest Update – Unleash the Light
